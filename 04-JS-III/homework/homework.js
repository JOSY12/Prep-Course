...
function cuentoElementos(arreglo) {
  ...
  console.log(
    "el maximo de elementos mayor a 18 es: " +
      contador +
      " y estos son " +
      contenedor
  );
...
function mesesDelAño(array) {
  ...
  if (
    todosmeses.includes("enero") &&
    todosmeses.includes("marzo") &&
    todosmeses.includes("noviembre")
  ) {
...
function breakStatement(numero) {
  ...
  for (i = 0; i < 10; i++) {
    ...
    if (i === numero) {
      console.log(
        "Se interrumpió la ejecución el valor de i: " +
          i +
          " y el valor de el numero sumado 2 es: " +
          numero
      );
      break;
    }
